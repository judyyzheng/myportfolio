...
function Social() {
    ...
    return (
        <div class="wrapper">
            ...
            <a href="https://github.com/judyyzheng" class="social-link social-link--github" id="github">
            ...
            <a href="https://www.linkedin.com/in/judy-zheng-852258160/" class="social-link social-link--linkedin" id="linkedin">
                <svg class="social-svg" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                <title>
                    linkedin
                </title>
            ...
            <a href="www.instagram.com/judyyzheng" class="social-link social-link--instagram" id="instagram">
                <svg class="social-svg" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                <title>
                    instagram
                </title>
